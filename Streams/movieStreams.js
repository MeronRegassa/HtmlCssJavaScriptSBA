document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(' https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=20&playlistId=UUWhCVykRa2tgmziv5PNgkJA&key=AIzaSyBebBG1LZybOz5DNDdZMq35nwsVqRnKeUk ')
        .then(res => res.json())
        .then(data => {
